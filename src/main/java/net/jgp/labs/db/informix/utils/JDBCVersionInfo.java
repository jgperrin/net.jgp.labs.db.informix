...
public class JDBCVersionInfo {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println(
          "An error occured while accessing metadata: " + e
              .getMessage());
      return;
    }

    try {
      System.out.println("Driver name ............ " + dbmd
          .getDriverName());
      System.out.println("Driver version ......... " + dbmd
          .getDriverVersion());
      System.out.println("Driver major version ... " + dbmd
          .getDriverMajorVersion());
      System.out.println("Driver minor version ... " + dbmd
          .getDriverMinorVersion());
      System.out.println("Database name .......... " + dbmd
          .getDatabaseProductName());
      System.out.println("Database version ....... " + dbmd
          .getDatabaseProductVersion());
    } catch (SQLException e) {
      System.err.println(
          "An error occured while extracting metadata: " + e
              .getMessage());
    }
  }
}
